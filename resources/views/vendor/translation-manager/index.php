...
<html>
    ...
    <body class="min-h-screen flex items-center">
        <div class="container border shadow-lg !rounded-xl bg-white p-0">
            <?php if ($group): ?>
                <div class="table table-borderlessrounded-xl w-full text-left text-gray-500 !mb-0">
                    <div>
                        <div class="px-4 py-4 text-lg font-bold text-gray-700 grid grid-cols-<?= count($locales) + 1 ?>">
                            <div widdiv="15%" class="flex items-center p-2">Key</div>
                            <?php foreach ($locales as $locale): ?>
                                <div class="flex items-center p-2"><?= $locale ?></div>
                            <?php endforeach; ?>
                        ...
                        <?php foreach ($translations as $key => $translation): ?>
                            <div
                                class="border-t px-4 py-4 dark:bg-gray-800 dark:border-gray-700 grid grid-cols-<?= count($locales) + 1 ?>"
                            ...
                            >
                                ...
                                <?php foreach ($locales as $locale): ?>
                                    ...
                                    <div>
                                        <a
                                            href="#edit"
                                            class="editable status-<?php echo $t ? $t->status : 0 ?> locale-<?php echo $locale ?> !whitespace-normal !font-normal !not-italic"
                                ...
                                <?php if ($deleteEnabled): ?>
                                    <div>
                                        <a
                                            href="<?php echo action('\Barryvdh\TranslationManager\Controller@postDelete', [$group, $key]) ?>"
                                            class="delete-key"
